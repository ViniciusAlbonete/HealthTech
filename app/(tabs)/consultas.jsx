  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.content}>
        ...
        {renderConsulta(
          { name: 'Dra. Paula Tejano', image: 'https://example.com/ana-lucia.jpg' },
          'Angiologista',
          '01/02/2022',
          true
        )}
        {renderConsulta(
          { name: 'Dr. Thomas Turbano', image: 'https://example.com/paulo-matos.jpg' },
          'Otorrinolaringologista',
          '05/05/2022',
          true
        )}
        {renderConsulta(
          { name: 'Dr. John Dick Penis', image: 'https://example.com/mariana-luz.jpg' },
          'Mastologista',
          '07/10/2022',
          true
        )}
